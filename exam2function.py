...
26 October 2015, revised 7 March 2016
...
#    print question
    ...
    print('This is the definition of the alias "q1": \
...
def q2():
    ...
    cmd.set_view('(0.61,0.29,-0.73,0.78,-0.37,\
    ...
    cmd.print('This is the definition of the alias "q2": \
    3v6d, HIVrt, async=0; rock;show cartoon, c. P or c. T;\
...
#    print question
    ...
    cmd.rock()
    cmd.set_view('(0.53,-0.06,-0.84,0.82,-0.21,0.53,\
    ...
    print('This is the definition of the alias "q3": \
...
def q4():
    ...
    print('This is the definition of the alias "q4": \
    fetch 3v6d, HIVrt, async=0; \
    preset.ball_and_stick("(c. C and i. 258) or (c. F and i. 817 )"); \
    set_view (-0.5,-0.29,0.82,-0.21,0.95,0.21,-0.84,-0.07,-0.54,-0.0,\
    0.0,-192.95,-18.45,10.92,-12.11,152.12,233.77,-20.0);')
cmd.extend('q4',q4)
...
def q5():
    ...
    cmd.rock()
    cmd.set_view('(-0.5,0.18,-0.85,-0.17,-0.98,-0.11,-0.85,0.09,0.52,0.0,0\
    ...
    print('This is the definition of the alias "q5": \
...
def q6():
   ...
   ligands are from RNA?
    ...
    print('This is the definition of the alias "q6": \
...
def q7():
    ...
    cmd.rock()
    cmd.set_view('(0.62,0.14,0.78,0.13,-0.99,0.07,0.78,\
    ...
    print('This is the definition of the alias "q7":\
...
def q8():
   ...
   nucleotides in this base pair?   
    ...
    cmd.set_view('(-0.9,-0.19,0.39,0.39,-0.74,0.55,0.19,0.65,0.74,\
    ...
    print('This is the definition of the alias "q8": \
